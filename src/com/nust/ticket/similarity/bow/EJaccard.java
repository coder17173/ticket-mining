...
public class EJaccard {
	public static void main(String[] args)
	{
		String string1 = "high space use";
		String string2 = "high space use";
		System.out.println(new EJaccard().EJaccardDis(string1, string2));
	}
	
	public double EJaccardDis(String str1, String str2)
	{
		double sim = 0.0;
		...
		return count/(str1s.length+str2s.length - count);
	}
}
